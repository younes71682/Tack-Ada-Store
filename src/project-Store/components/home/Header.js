...
const Header = ({ onSearch }) => {
  ...
  const handleChange = (data) => {
    onSearch(data.searchValue); // فراخوانی تابع جستجو با مقدار ورودی
  };

  return (
    <form
      onSubmit={handleSubmit(handleChange)} // سابمیت فرم هنگام تغییر ورودی
    ...
    >
      <input
        ...
        onChange={(e) => {
          handleChange({ searchValue: e.target.value }); // به‌روزرسانی ورودی به محض تغییر
        }}
      />
